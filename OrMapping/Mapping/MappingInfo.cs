...
namespace Ausm.ObjectStore.OrMapping
{
    ...
    {
        void Fill(System.Data.IDataRecord reader);
    ...
    internal class MappingInfo
    {
        ...
        protected Func<System.Data.IDataReader, MappedObjectKeys> _getKeyObjectFromReader;
        ...
        protected virtual void Initialize()
        {
            #region Tabellennamen bestimmen
            {
                ...
                {
                    TableName = ((TableAttribute)attributes[0]).TableName;
                    _loadBehavior = ((TableAttribute)attributes[0]).LoadBehavior;
                }
            }
            #endregion
            ...
            foreach (PropertyInfo item in Type.GetProperties(System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.GetProperty).Where(x =>
            {
            ...
            {
                DynamicMethod method = new DynamicMethod("getKey", typeof(MappedObjectKeys), new Type[] { typeof(System.Data.IDataReader) }, true);
                ...
                _getKeyObjectFromReader = (Func<System.Data.IDataReader, MappedObjectKeys>)method.CreateDelegate(typeof(Func<System.Data.IDataReader, MappedObjectKeys>));
            }
            #endregion
            ...
            else
            {
                MethodInfo raiseMethodeInfo = Type.GetMethods(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public).Where(x =>
                        ...
                        x.GetCustomAttributes(typeof(IsRaisePropertyChangeMethodAttribute), true).Length > 0).FirstOrDefault();
            ...
            PropertyBuilder stateProperty = typeBuilder.DefineProperty("IFillAbleObject.State", PropertyAttributes.None, typeof(State), Type.EmptyTypes);
            ...
            #region FillMethode
            MethodBuilder fillMethode = typeBuilder.DefineMethod("IFillAbleObject.Fill", MethodAttributes.Public | MethodAttributes.Virtual, null, new Type[] { typeof(System.Data.IDataRecord) });
            ...
            #region KeysProperty
            PropertyBuilder keyProperty = typeBuilder.DefineProperty("IFillAbleObject.Keys", PropertyAttributes.None, typeof(MappedObjectKeys), Type.EmptyTypes);
            ...
            PropertyBuilder modifiedProperty = typeBuilder.DefineProperty("IFillAbleObject.Modified", PropertyAttributes.None, typeof(MappedObjectKeys), Type.EmptyTypes);
        ...
        public virtual MappedObjectKeys GetKeyValues(System.Data.IDataReader reader)
        {
        ...
        {
            List<Mapping> keyMappingInfos = this.KeyMappingInfos;
            if (keyMappingInfos.Count != 1)
                throw new Ausm.ObjectStore.OrMapping.Expressions.NotParsableException("ParameterExpressions of mapped types witch has no key or a segmented key cannot be parsed.");
        ...
        protected virtual List<Mapping> KeyMappingInfos
        {
            get
            {
